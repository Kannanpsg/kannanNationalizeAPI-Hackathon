//using async function & fetch - calling the api 
...
//To get i/p from the source to table for align and follows by catch error
...
document.body.style.backgroundColor = "#ab2222";
